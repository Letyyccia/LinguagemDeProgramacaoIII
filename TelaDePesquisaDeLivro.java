...
public class TelaDePesquisaDeLivro {
    public static void main(String[] args) {
        ...
        try {
            List<Livro> livros = em.createQuery("SELECT l FROM Livro l WHERE l.nome LIKE :nome OR l.edicao LIKE :edicao", Livro.class)
            ...
            if (!livros.isEmpty()) {
                ...
                for (Livro l : livros) {
                    System.out.println("ID: " + l.getId() + " | Nome: " + l.getNome() + " | Edicao: " + l.getEdicao());
                }
            } else {
